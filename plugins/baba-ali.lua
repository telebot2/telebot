do
local Dev = 181803152 --put your id here(BOT OWNER ID)
...
local function setrank(msg, name, value) -- setrank function
  ...
  if hash then
	...
	return send_msg('chat#id'..msg.to.id, 'مقام شما ('..name..') به '..value..' تغییر داده شد ', ok_cb,  true)
  end
end
